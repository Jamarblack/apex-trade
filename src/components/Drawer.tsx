...
export function Drawer({
  ...
  return (
    <>
      ...
      />
      <aside
        className={`fixed bottom-0 top-0 z-50 flex w-[88vw] max-w-[360px] flex-col border-white/5 bg-[color:var(--background)] transition-transform lg:hidden ${side === "left" ? "left-0 border-r" : "right-0 border-l"} ${open ? "translate-x-0" : side === "left" ? "-translate-x-full" : "translate-x-full"}`}
      >
