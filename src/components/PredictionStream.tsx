...
function PredictionCard({ p, live }: { p: Prediction; live: boolean }) {
  ...
  return (
    <li
      className={`group rounded-md border border-border bg-[color:var(--surface-2)] p-3 transition-colors hover:border-foreground/20 ${live ? "ring-1 ring-[color:var(--sol-green)]/30 shadow-[0_0_12px_rgba(20,241,149,0.1)]" : ""}`}
    >
